...
def main():
    ...
    have_subdir = input_boolean(
        'Create source files in src subdirectory', False)
    rootpath = name
    ...
    create_file(SERVICE, srcpath, 'org.osdlyrics.LyricSourcePlugin.' +
                name + '.service.in', params)
    if have_am:
